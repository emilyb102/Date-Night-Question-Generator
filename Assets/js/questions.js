const allQuestions = [
    ...
    },
    {
        ...
        questions: [
            ...
            {
                text: "What choices have you made in the last five years that you'd thank yourself for making?"
            },
            {
                text: "What's something you did well recently, and what qualities or skills enabled you to do this?"
            },
            {
                text: "What's something you're looking forward to in the future?"
            },
            {
                text: "What's something that you'd like to try, but that you're too scared to try?"
            },
            {
                text: "Who made a positive difference in your life recently?"
            },
            {
                text: "What's something enjoyable you get to experience every day that you've come to take for granted?"
            },
            {
                text: "Have you recently imagined a worst-case scenario that didn't actually happen?"
            },
            {
                text: "What are three things your arms or legs allow you to do that you enjoy?"
            },
            {
                text: "Who in your life has survived something difficult, and how do you feel when you think about the fact that they're still here?"
            },
            {
                text: "What's the kindest thing someone has done for you lately?"
            }]
    },
    {
        name: "Cozy",
        ...
        questions: [
            ...
            {
                text: "What is a small joy that you enjoy?"
            },
            {
                text: "What is a kind or thoughtful thing someone did for you recently?"
            },
            {
                text: "Who is always there for you & how do you feel about them?"
            },
            {
                text: "Who has helped you become the person you are today, and what's the top thing you'd thank them for?"
            },
            {
                text: "Can you think of any non-physical gifts you've received recently—someone's time, attention, understanding, or support?"
            },
            {
                text: "What's the best thing that happened today so far?"
            },
            {
                text: "Who's someone who always really listens when you talk, and how does that affect you?"
            },
            {
                text: "Who have you enjoyed being around recently, and why?"
            },
            {
                text: "How have you used your talents and abilities recently, and what have you enjoyed about doing that?"
            },
            {
                text: "What have you learned recently that will help you in the future?"
            },
            {
                text: "What's the last song you heard that you enjoyed? How did it make you feel, and why?"
            },
            {
                text: "Have you experienced any blessings in disguise lately, things that didn't turn out as you'd hoped and yet turned out for the best?"
            },
            {
                text: "What's one of the best things about your home, and have you taken time to enjoy it recently?"
            },
            {
                text: "What's something you witnessed recently that reminded you that life is good?"
            },
            {
                text: "What's something you witnessed recently that reminded you that people are good?"
            },
            {
                text: "What event or interaction made you feel good about yourself recently?"
            },
            {
                text: "What's the most beautiful thing you saw today?"
            },
            {
                text: "What's the kindest thing someone has done for you lately?"
            },
            {
                text: "What have you seen in nature recently that made you feel happy, peaceful, or free?"
            }]
    }
]
